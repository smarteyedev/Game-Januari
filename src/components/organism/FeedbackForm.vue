<template>
  <div class="flex flex-col h-full gap-4 w-[90vw]">
    ...
    <div class="flex justify-center gap-3 mt-6">
      <span v-for="star in 5" :key="star" class="cursor-pointer select-none text-5xl leading-none"
        :class="star <= (hoverRating || rating) ? 'text-yellow-400' : 'text-gray-300'" @click="rating = star"
